...
<main
	class="mx-auto mt-24 grid max-w-2xl grid-cols-2 place-content-center gap-6 px-10 tracking-tighter [font-family:Futura,ui-serif,Georgia,Cambria,'Times_New_Roman',Times,serif]"
>
